...
# Import blueprints
from api.admin.login import login_bp
from api.admin.dashboard import dashboard_bp
from api.admin.profiles import profiles_bp
from api.admin.experience import experience_bp
from api.admin.projects import projects_bp
from api.admin.skills import skills_bp
from api.admin.upload import upload_bp
from api.utama.utama import utama_bp
...
if __name__ == '__main__':
    # Hapus 'app = create_app()' dari dalem sini
